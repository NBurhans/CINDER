...
Formulas are given for Gen 3, the base for the overwhelming majority of ROM hacks. Hacks built on pokeemerald-expansion often backport later-generation mechanics — **verify against the hack's own source before applying any of these**, and mark results as *Inferred* whenever a formula is assumed rather than confirmed from the data.
